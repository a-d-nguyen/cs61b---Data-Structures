...
public class TestPlip {
    ...
    public void testReplicate() {
        Plip babyMaker = new Plip(2);
//        double testEnergy = 1;
        Plip baby = babyMaker.replicate();
...
//
//        Action actual1 = idk.chooseAction(surrounded);
//        Action expected1 = new Action(Action.ActionType.REPLICATE);
//
//        assertEquals(actual1, expected1);
        ...
        Action actual2 = x.chooseAction(surrounded);
